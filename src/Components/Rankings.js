...
const Rankings = () => {
  ...
  return (
    ...
    <div className="relative w-full md:pt-20 pb-10 overflow-hidden  select-none bg-gradient-to-b from-black to-slate-800 bg-[linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8520658263305322) 100%)] text-white">
      ...
      <div className={`flex justify-center  md:max-w-[90%] w-full md:pt-0 pt-5  content-center ${topTen.length == 0 ? "max-h-[calc(100vh-61px)]" : ""}  mx-auto  min-h-[calc(100vh-61px)] p-2 md:p-5`}>
...

            {
              ...
              :
                <div className='   flex flex-col  md:pt-0 pt-14'>
                  <div className='w-[90vw]  mx-auto     md:min-w-[80%] md:max-w-[80%]    grid grid-rows-3 grid-cols-none md:grid-cols-3 md:grid-rows-none md:gap-2'>
                            ...
                            <div className='md:min-w-[70%]  md:max-w-[70%] mx-auto    rounded-lg'>
                              {
                                index == 0 || index == 1 || index == 2 ?
                                  <div></div>
                                  :
                                  <div className='text-lg md:text-xl relative w-full flex md:flex-row flex-col align-middle  justify-between  rounded-lg py-1 md:py-3 bg-slate-700 shadow-custom-box'>
                                    <span className='flex gap-3 align-middle md:pl-6 justify-start md:justify-center items-center'>
                                      <span className={` text-5xl md:text-7xl md:m-0 m-2  -top-3 font-bold shadow-custom-box-small bg-indigo-700 py-0 md:py-1 pt-1  pb-1 md:pt-2 md:pb-0  ${index == 9 ? "px-0 md:px-2" : "px-4 md:px-6"} rounded-full `}>{index + 1}</span>
